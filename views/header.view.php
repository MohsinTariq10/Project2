  ...
  <div class="intro-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-2">
        <a href="login.php" style="text-decoration:none"><h4 style="color:#f2e7f2">Login | Sign-up <span class="glyphicon glyphicon-user"style="color:white; font-size:20px"></span></h4></a>
        </div>
